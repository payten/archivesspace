...
describe "RDE" do
  ...
  it "can add a child via the RDE form" do
    ...
    expect {
      check_tree_node_for_title('My AO, 2013')
      check_tree_node_for_title('Item')
    }.not_to raise_error
  end
  ...
  it "can add multiple children and sticky columns stick" do
    ...
    assert(5) {
      check_tree_node_for_title('Child 1, 2013')
      check_tree_node_for_title('Child 2, 2013')
    }
  end
...
describe "Digital Object RDE" do
  ...
  it "can add a child via the RDE form" do
    ...
    assert(5) {
      check_tree_node_for_title('My DO')
    }
  end
  ...
  it "can add multiple children and sticky columns stick" do
    ...
    assert(5) {
      check_tree_node_for_title('Child 1')
      check_tree_node_for_title('Child 2')
    }
  end
